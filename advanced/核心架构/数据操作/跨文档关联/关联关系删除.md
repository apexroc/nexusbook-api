...
```bash
curl -X DELETE 'https://open.nexusbook.app/api/v1/doc/order/123/relations/rel-789' \
...
```bash
curl -X DELETE 'https://open.nexusbook.app/api/v1/doc/project/456/relations/batch?fieldId=members' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
...
```bash
curl -X DELETE 'https://open.nexusbook.app/api/v1/doc/order/123/relations/batch?targetDocType=product&targetDocId=prod-789' \
  -H 'Authorization: Bearer YOUR_ACCESS_TOKEN'
```
...
curl -X DELETE 'https://open.nexusbook.app/api/v1/doc/doc/123/relations/rel-abc'
```
