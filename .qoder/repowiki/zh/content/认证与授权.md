...
E["common.tsp<br/>统一响应/错误码/查询模型"]
F["constants.tsp<br/>通用枚举与常量"]
end
subgraph "文档与指南 docs-src"
G["guides/authentication.md<br/>认证流程与示例"]
H["guides/best-practices.md<br/>安全与最佳实践"]
I["references/error-codes.md<br/>错误码参考"]
end
A --> B
A --> C
A --> D
...
- [api/auth/models.tsp](file://api/auth/models.tsp#L1-L339)
...
图表来源
- [api/auth/models.tsp](file://api/auth/models.tsp#L278-L339)
...
章节来源
- [api/auth/models.tsp](file://api/auth/models.tsp#L317-L339)
- [docs-src/guides/authentication.md](file://docs-src/guides/authentication.md#L171-L211)

## 依赖关系分析
- 模块耦合
  - api/auth/index.tsp 统一导入 models、registration、apikeys，形成认证模块聚合
  - models 与 registration、apikeys 均依赖 api/shared/common.tsp 提供统一响应与错误模型
- 外部依赖
